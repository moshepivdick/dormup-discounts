    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-4 text-center">
          ...
          <CardDescription>Join DormUp to access student discounts</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    'pl-12',
                    (error || fieldErrors.email) && 'border-rose-300',
                  )}
                />
              </div>
              {fieldErrors.email && (
            ...
            <div>
              ...
              <Input
                ...
                required
                disabled={loading}
                className={cn((error || fieldErrors.password) && 'border-rose-300')}
              />
            ...
            {error && !fieldErrors.email && !fieldErrors.password && !fieldErrors.universityId && (
